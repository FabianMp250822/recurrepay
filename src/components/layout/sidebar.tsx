...
const navItems = [
  ...
  // Add more items later if needed e.g.
      ...
      <div className="mt-auto p-4 border-t border-sidebar-border">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-xs text-muted-foreground">admin@recurpay.com</p>
          </div>
        </div>
        <Button variant="ghost" className="w-full justify-start mt-3 hover:bg-sidebar-accent hover:text-sidebar-accent-foreground">
